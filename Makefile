...
#    Updated: 2025/06/12 09:17:45 by jakobadrian      ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_strlen.c ft_strlcpy.c ft_isalpha.c ft_isdigit.c ft_isalnum.c \
	...
	ft_strnstr.c ft_toupper.c ft_tolower.c ft_bzero.c ft_memchr.c \
	ft_memcmp.c ft_atoi.c ft_calloc.c ft_strdup.c 
